...
def train_test_split(x_trainwell, y_trainwell, test_loc, test_inc):
    ...
    for i in range(test_len):
        for j in range(len(x_trainwell)):
            if X_test[i,0] == x_trainwell[j,0] and X_test[i,n_features-1] == x_trainwell[j,n_features-1] and X_test[i,n_features-2] == x_trainwell[j,n_features-2] and X_test[i,n_features-3] == x_trainwell[j,n_features-3]:
